          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 flex-1 lg:ml-12">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><Link prefetch={false} href="/careers" className="hover:text-foreground transition-colors">Careers</Link></li>
                <li><Link prefetch={false} href="/contact" className="hover:text-foreground transition-colors">Contact</Link></li>
              </ul>
            </div>
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><Link prefetch={false} href="/status" className="hover:text-foreground transition-colors">Status</Link></li>
                <li><Link prefetch={false} href="/changelog" className="hover:text-foreground transition-colors">Changelog</Link></li>
              </ul>
            </div>
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><Link prefetch={false} href="/security" className="hover:text-foreground transition-colors">Security</Link></li>
                <li><Link prefetch={false} href="/cookies" className="hover:text-foreground transition-colors">Cookies</Link></li>
              </ul>
            </div>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              <Link prefetch={false} href="/privacy" className="text-sm text-muted-foreground hover:text-foreground">
                Privacy Policy
              </Link>
              <Link prefetch={false} href="/terms" className="text-sm text-muted-foreground hover:text-foreground">
                Terms of Service
              </Link>
            </div>
          </div>
